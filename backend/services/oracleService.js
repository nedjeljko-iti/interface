...
// Thick mode — zahtijeva Oracle Instant Client 64-bit.
// Putanja se postavlja u .env kao ORACLE_CLIENT_LIB.
...
async function callImportProcedure(clobs, username) {
  initClient();
  const connConfig = {
  ...
  try {
    ...
    // DEBUG — prvih 5 vrijednosti svakog parametra

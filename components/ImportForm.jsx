...
import { getToken, removeToken, getUser } from '@/lib/auth-client';
...
export default function ImportForm({ onLogout }) {
  const user = getUser();
      ...
      <div style={s.content}>
        ...
        {!rows && !previewErr && !previewing && (
          <div style={s.emptyState}>
            ...
            <p style={s.emptyTitle}>Odaberite CSV datoteku za import</p>
            <p style={s.emptyHint}>Nakon odabira, podaci će se prikazati u tablici za pregled</p>
          </div>
        )}
